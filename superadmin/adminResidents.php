  ...
  <div class="modal-content">
    ...
    <form id="residentForm">
      ...
      <div class="form-grid">
        ...
        <label><span style="color: red">*</span>Address: <input type="text" id="address" name="address" required /></label>
        ...
        <label>PWD ID No: <input type="text" id="pwd_id_no" name="pwd_id_no" pattern="PWD-\d{4}-\d{4}" title="Format: PWD-XXXX-XXXX" disabled/></label>
        ...
        <label>Solo Parent ID No: <input type="text" name="solo_parent_id_no" id="solo_parent_id_no" pattern="SP-\d{4}-\d{4}" title="Format: SP-XXXX-XXXX" disabled /></label>
        ...
        <label><span style="color: red">*</span>COVID Status: <input type="text" id="covid_status" name="covid_status" required /></label>
  ...
  <div class="modal-content">
    ...
    <form id="addResidentForm">
      <div class="form-grid">
        ...
        <label><span style="color: red">*</span>Address: <input type="text" name="address" required /></label>
        <label><span style="color: red">*</span>PWD: 
        ...
        <label>PWD ID No: <input type="text" id="pwdIdField" name="pwd_id_no" pattern="PWD-\d{4}-\d{4}" title="Format: PWD-XXXX-XXXX" disabled/></label>
        <label><span style="color: red">*</span>Indigent: 
          <select name="indigent" required>
            <option value="No">No</option>
            <option value="Yes">Yes</option>
        ...
        <label>Solo Parent ID No: <input type="text" name="solo_parent_id_no" id="spIdField" pattern="SP-\d{4}-\d{4}" title="Format: SP-XXXX-XXXX" disabled /></label>
        <label><span style="color: red">*</span>Member of 4Ps: 
