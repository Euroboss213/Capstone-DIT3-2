...
$sql = "SELECT * FROM good_moral WHERE user_id = ?";
...
<head>
  ...
  <script src="../js/users_openGoodMoralModal.js" defer></script>
</head>
<body>
    <!-- Modal part -->
    <div id="reviewModal" class="modal">
        <div class="modal-content">
            ...
            <form id="reviewForm" class="form" name="update_usersGoodMoral">
                <!-- Hidden Inputs -->
