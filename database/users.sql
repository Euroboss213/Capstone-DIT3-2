...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2025 at 01:46 PM
...
INSERT INTO `users` (`id`, `username`, `password`, `first_name`, `middle_name`, `last_name`, `suffix`, `birth_date`, `birth_place`, `age`, `sex`, `civil_status`, `nationality`, `religion`, `occupation`, `contact_number`, `address`, `pwd`, `pwd_id_no`, `indigent`, `solo_parent`, `solo_parent_id_no`, `member_4ps`, `family_monthly_income`, `registered_voter`, `purok_no`, `house_no`, `street`, `emergency_full_name`, `emergency_relationship`, `emergency_contact_no`, `emergency_address`, `national_id_no`, `philhealth_no`, `sss_no`, `pagibig_no`, `tin_no`, `voters_id_no`, `covid_status`, `vaccinated`, `date_of_registration`, `date_of_death`, `alive_or_deceased`, `residence_id`) VALUES
(4, 'mdsr@gmail.com', '$2y$10$DnJYZM8eKdXJGmSx0UKwxupGi5shVfDO2vHgVdi9MqmwfAVF.3Cty', 'Maria', 'Delos Santos', 'Reyes', '', '1985-08-20', 'Cebu', 40, 'Female', 'Married', 'Filipino', 'Christian', 'Teacher', '09234567890', '2345 Sample St., Barangay 2, Cebu', 'No', NULL, 'Yes', 'No', NULL, 'Yes', 30000.00, 'Yes', '2', '202', 'Main St.', 'Carlos Reyes', 'Husband', '09213456789', '6789 Emergency Rd., Cebu', '234567890123', 'PH234567', 'SSS234567', 'PAGIBIG234', 'TIN234567890', 'VOTER23456', 'Negative', 'Yes', '2025-04-05 17:27:17', NULL, 'Alive', NULL),
(5, 'jerrualen@gmail.com', '$2y$10$JBcsZ5O4jIwiOMIciJ/hAeyp//95PbtNhO98VN4/6T83LPVSxo/4S', 'John', 'Doe', 'Smith', 'Jr.', '1990-05-15', 'Manila', 35, 'Male', 'Single', 'Filipino', 'Christian', 'Engineer', '09171234567', '1234 Sample St., Barangay 1, Manila', 'Yes', 'PWD12345', 'No', 'No', 'SPID1234', 'Yes', 25000.00, 'Yes', '1', '101', 'Sample St.', 'Jane Doe', 'Mother', '09182345678', '5678 Emergency Ave, Manila', '123456789012', 'PH123456', 'SSS123456', 'PAGIBIG123', 'TIN123456789', 'VOTER12345', 'Negative', 'Yes', '2025-04-05 17:27:17', NULL, 'Alive', NULL);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`residence_id`) REFERENCES `admin`.`residences` (`id`);
COMMIT;
